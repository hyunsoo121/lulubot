...
export function readFilterOptions(interaction: ChatInputCommandInteraction): FilterOptionsResult {
  const serverOnly = interaction.options.getBoolean('서버기반') ?? false;
